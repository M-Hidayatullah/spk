                ...
                for($i = 0; $i < count($alternatif); $i++) {
                    if (isset($nilai[$i])) {
                        ...
                        echo '<tr>
                                <td class="col-md-1">'.($i+1).'</td>
                                <td class="col-md-3">'.$alternatif[$i]['alternatif'].'</td>
                                <td class="col-md-1"><input class="form-control" type="text" name="c[0][]" placeholder="1 - 60"/></td>
                                <td class="col-md-1"><input class="form-control" type="text" name="c[1][]" placeholder="1 - 50"/></td>
                                <td class="col-md-1"><input class="form-control" type="text" name="c[2][]" placeholder="70"/></td>
                                <td class="col-md-1"><input class="form-control" type="text" name="c[3][]" placeholder="1 - 15"/></td>
                                <td class="col-md-1"><input class="form-control" type="text" name="c[4][]" placeholder="1 - 30"/></td>
                                <td class="col-md-1"><input class="form-control" type="text" name="c[5][]" placeholder="1 - 40"/></td>
                            </tr>';
                    }
                }
            } else {
